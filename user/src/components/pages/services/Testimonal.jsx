            ...
            <section className="our-services-area bg-gray section-padding-100-0">
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            {/* Section Heading */}
                            <div className="section-heading text-center py-5 bg-light border-bottom">
                                <h2 className="display-4 mb-4">OUR SERVICES</h2>
                                <p className="lead text-muted mx-auto" style={{ maxWidth: "800px" }}>
                                    We TEI Foundation team focuses to help people with lower wages. We intend to provide them with ease and wish to make their life simple and flexible by providing some basic support.
                    ...
                    <div className="row align-items-center justify-content-between">
                            ...
                            <div className="alazea-service-area mb-100">
                                ...
                                <div className="col-sm-12">
                                    ...
                                    <div className="service-content">
                                        ...
                                        <p style={{ textAlign: "justify" }}>Poverty and malnutrition have always been a huge problem for India, especially in the rural areas and tribal belts. COVID-19 created an alarming situation for people who were already below the poverty line, as they did not have even odd jobs to work during this difficult time.
                                ...
                                <div className="single-service-area d-flex align-items-center">
                                    ...
                                    <div className="service-content">
                                        ...
                                        <p style={{ textAlign: "justify" }}>IIn the Emerging India Foundation we are working with /Municipality/Urban Local Bodies (ULBs) for providing wholesome healthy living environment for the residents and thus contributing to growth of clean, green, healthy and sustainable cities.
                                ...
                                <div className="single-service-area d-flex align-items-center">
                                    ...
                                    <div className="service-content">
                                        ...
                                        <p style={{ textAlign: "justify" }}>To provide cashless quality medical care to beneficiaries under the scheme for catastrophic illnesses requiring hospitalization for surgeries and therapies under identified specialty services through a network of health care providers..WE Provide 51005+ mask .AROGYA scheme has been launched to cover the bottom 70% of poor and economically weaker sections of the country. The Arogya Yojana Eligibility is designed with pre-conditions so that only the underprivileged people of the society benefit from the initiative..</p>
                                        <br />
                                        <div className="col-12 col-lg-6">
                                            <div className="alazea-video-area bg-overlay mb-100">
                                                <img src="img/bg-img/23.jpg" alt="" />
                        ...
                        <div className="single-service-area d-flex align-items-center">
                            ...
                            <div className="service-content">
                                ...
                                <p style={{ textAlign: "justify" }}>Eliminate open defecation: The campaign aims to make India open-defecation free by constructing toilets and promoting the use of sanitation facilities. The campaign focuses on changing people's behavior towards open defecation and promoting the use of toilets.
                ...
                <div className="container">
                    ...
                    <div className="service-content">
                        ...
                        <p style={{ textAlign: "justify" }}>Blood donation Yojana To make aware the people all over the country about the importance of the voluntary blood donation.
                ...
                <div className="container">
                    ...
                    <div className="service-content">
                        ...
                        <p style={{ textAlign: "justify" }}>Life has completely changed for everybody with the outbreak of a global Pandemic Covid-19. The care and protection is the need of an hour. There are responsibilities towards our countrymen and we ought to discharge our duties more sincerely and with utmost responsibilitiesThe number of masks distributed goes around 51005+ and not only they distributed the masks but also interacted with the localitiy. They created an awareness about the present situation and guided the villagers how to positively approach this difficult phase.
                ...
                <div className="container">
                    ...
                    <div className="service-content">
                        ...
                        <p style={{ textAlign: "justify" }}>To provide cashless quality medical care to beneficiaries under the scheme for catastrophic illnesses requiring hospitalization for surgeries and therapies under identified specialty services through a network of health care providers..WE Provide 71005+ people free treatment for any disease .AROGYA scheme has been launched to cover the bottom 70% of poor and economically weaker sections of the country. The Arogya Yojana Eligibility is designed with pre-conditions so that only the underprivileged people of the society benefit from the initiative..</p>
                        <br />
                ...
                <div className="container">
                    ...
                    <div className="service-content">
                        ...
                        <p style={{ textAlign: "justify" }}>Meaning of road safety
